...
public class LXC {
	...
	public String toString() {
		String chaine="";
		chaine+=this.name+" ("+this.vmid+")\n";
		chaine+="Status("+this.status+")\n";
		chaine+="Cpu Usage : "+this.cpu+"% of "+this.cpus+" cpus\n";
		float usedMemory=(float)this.mem/(float)this.maxmem;
		chaine+="Memory Usage :"+usedMemory+"% ( "+this.mem/1000000+ " MiB of"+this.maxmem/1000000 +"MiB )"+"\n";
		float usedDisk=(float)this.disk/(float)this.maxdisk;
		chaine+="Disk Usage : "+usedDisk+"% \n";
		return chaine;
	}
